...
export const me = {
  ...
  card: [
    ...
    { label: "CURRENTLY", value: "Shipping product dashboards at TCS + tinkering after hours" },
...
export const board = [
  {
    ...
    color: "lime",
    items: [
      "A dashboard that finally makes sense of 10+ product feeds",
      "Schema-validation middleware that yells politely",
    ],
  },
  {
    tag: "EXPERIMENTING",
  ...
  },
  {
    tag: "MAYBE",
    color: "sunny",
    items: ["A tiny mandi-price app for my hometown", "A CLI nobody asked for"],
  },
  {
    tag: "SOMEDAY",
    color: "cherry",
...
export const episodes = [
  ...
  },
  {
    ...
    color: "lime",
    beats: [
      "Building products end to end, not just tickets.",
      "Side quests at night. This website is one of them.",
    ],
...
export const sideQuests = [
  ...
  { title: "Mandi price scraper", note: "half a scraper and one very confused cron job", state: "abandoned" },
...
export const facts = [
  ...
  { k: "ASK ME ABOUT", v: "RBAC, schema validation, or why Mongo is not always the answer" },
