  ...
  return (
    <div className="py-2 lg:py-10 h-auto min-h-screen">
      <div className="flex justify-center">
        <h1 className="p-4 md:p-0 font-poor text-green-900 text-8xl md:text-9xl font-semibold">
          Skills
        </h1>
      </div>
      <div className="flex items-center flex-col gap-4 mx-auto md:mt-2">
        <p className="text-black font-poor text-2xl md:text-5xl  font-bold rounded-xl">
          {" "}
          Skills are Earned{" "}
        </p>
      </div>
      ...
      {loading ? ( // Display loading Spinner
        <div className="flex items-center justify-center">
          <p className="mt-20 md:mt-[140px]">
            {" "}
            <img
              className="h-10 md:h-[110px] "
              src={loadingimg}
              alt="loading"
            />
          </p>
